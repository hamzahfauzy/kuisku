...
async function simpanKategori()
{
    ...
    let request = await fetch('<?= route('admin/category/insert') ?>',{
        method :'POST',
        headers : {
...
async function editKategori()
{
    ...
    let request = await fetch('<?= route('admin/category/update') ?>',{
        method :'POST',
        headers : {
            'Content-Type':'application/json'
        },
...
async function fetchEditKategori(id)
{
    ...
    let request = await fetch('<?= base_url() ?>/admin/category/find/'+id)
    let response = await request.json()
...
async function deleteKategori(id)
{
    Swal.fire({
        ...
        if (result.value) {
            let request = await fetch('<?= route('admin/category/delete') ?>',{
                method :'POST',
                headers : {
                    'Content-Type':'application/json'
                },
